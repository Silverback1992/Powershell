#Challenge from the Master Microsoft PowerShell Udemy course
#Copy files from folder to folder - create subfolder in destination based on extensions and copy files there
